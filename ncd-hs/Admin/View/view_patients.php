    ...
    <div id="content">
        ...
        <table cellpadding="0" cellspacing="0" class="display" id="test_table" class="fixed">
            ...
            <tr>
                ...
                <th width="5%">View</th>
                <th width="20%" align="center"> Edit | Delete</th>
            </tr>
            </thead>
            <tbody>
            <?php
            while ($row = mysql_fetch_assoc($results)) {
                ...
                <tr>
                    ...
                    <td align="center">
                        <a rel="facebox" href="update_patient.php?patientID=<?php echo $row['patientID']; ?>">
                            <img width="20" height="20" src="images/icon_edit.png"/></a> |


                        <a href="#" onclick="confirm_delete(<?php echo $row['patientID']; ?>);">
