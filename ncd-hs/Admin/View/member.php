        ...
        <table align="right">
            ...
            <tr>
                <td>
                    ...
                    <link href='css/btn.css' rel='stylesheet' type='text/css'></link>
                    <a href="new_user.php" class="button">
                        <span>Add User</span>
                    </a>
                </td>
            </tr>
    ...
    <div style="float:left; width:910px;">
        ...
        <section id="slideshow">
            ...
            <div class="container">
                ...
                <div class="slider">
                    <figure><img src="images/img/44.jpg" alt="" width="640" height="310"/>
                        <figcaption>More than 75% of all deaths worldwide are due to NCDs</figcaption>
                    </figure>
                    <figure><img src="images/img/22.jpg" alt="" width="640" height="310"/>
                        <figcaption>Get Vaccinated</figcaption>
                    </figure>
                    <figure><img src="images/img/33.jpg" alt="" width="640" height="310"/>
                        <figcaption>Stay Home When Sick<em>(do)</em> time</figcaption>
                    </figure>
                    <figure><img src="images/img/11.jpg" alt="" width="640" height="310"/>
                        <figcaption>Clean & Disinfect Commonly Used Surfaces</figcaption>
                    </figure>
                </div>
            </div>
