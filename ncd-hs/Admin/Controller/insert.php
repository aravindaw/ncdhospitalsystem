...
function drug_list() {
    ...
    require_once '../Model/insert.php';
    $obj_member = new patient();
    $result =$obj_member->add_drug_list($patent_id, $user_id, $drug,$time_period1, $time_period2, $time_period3, $time_period4, $count, $note);

    if ($result == 1) {
        header("location:../view/view_patient_notes.php?add=1");
    } else {
        header("location:../view/view_patient_notes.php?add=0");
    }
}
?>